...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    private String[] restaurants =new String[] {"NaiFoodStaff","Motherland","KenyanBestDishes","WestoneHotel","Uncle.J.Hotel","PortlandCityGrill", "Fat Head's Brewery",
            "Chipotle", "Subway", "Slappy Cakes", "Equinox", "Miss Delta's", "Andina" };
